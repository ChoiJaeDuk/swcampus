...
<body>
	...
	<h2
			style="color: #ffffff; text-align: center; padding: 5px 0px; background-color: #2d65f2;">리뷰상세</h2>
		...
		<button class="formbutton" style="float: left; margin-left:10px; background-color:#2D65F2; color: #EFF5FF; border: none; width: 49%; font-size: 22px; padding: 5px 0px;">삭제</button>
	</div>
